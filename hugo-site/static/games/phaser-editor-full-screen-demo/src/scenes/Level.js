...
import FullScreenButtonPrefab from "../FullScreenButtonPrefab.js";
/* START-USER-IMPORTS */
/* END-USER-IMPORTS */
...
export default class Level extends Phaser.Scene {
	...
	editorCreate() {
		...
		// fullScreenButtonPrefab
		const fullScreenButtonPrefab = new FullScreenButtonPrefab(this, 1228, 49);
		this.add.existing(fullScreenButtonPrefab);
